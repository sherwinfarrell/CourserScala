...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def findMax(tweet: Tweet) ={
    right.findMax(left.findMax(if (elem.retweets > tweet.retweets) elem else tweet))  }
